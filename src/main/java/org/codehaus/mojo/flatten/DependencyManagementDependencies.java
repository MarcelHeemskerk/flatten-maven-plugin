 ...
 */
public class DependencyManagementDependencies
{
    private Log log;
    ...
    public DependencyManagementDependencies()
    {
        ...
        getLog().info("**** DependencyManagementDependencies created");
    }

    /**
     * @param dependency is the {@link Dependency} to {@link Map#put(Object, Object) put} or {@link Map#get(Object) get}
     *            .
     * @return the {@link Map.Entry#getKey() key} for the {@link Dependency}.
     */
     ...
     * @return <code>true</code> if the given {@link Dependency} is contained in these {@link DependencyManagementDependencies},
    ...
    /**
     * @return a {@link List} with the {@link Dependency} objects contained in these {@link DependencyManagementDependencies}.
     */
